      ...
      <ScrollView style={homeStyles.menu} horizontal={true} showsHorizontalScrollIndicator={false} >
        {
          menuList.map((menuItem, index, list) => {
            return (<TouchableHighlight key={menuItem.SysNo} style={homeStyles.menuItem} activeOpacity={0.8} underlayColor={CompanyConfig.StyleColor.HomePageA.MenuItemPressBackground}
              onPress={() => {
